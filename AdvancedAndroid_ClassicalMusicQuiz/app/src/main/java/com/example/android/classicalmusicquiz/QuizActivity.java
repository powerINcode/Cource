...
public class QuizActivity extends AppCompatActivity implements View.OnClickListener, ExoPlayer.EventListener {
    ...
    private NotificationManager mNontifactionManager;
    ...
    protected void onDestroy() {
        ...
        mNontifactionManager.cancelAll();
    }
    ...
    private void showNotification(PlaybackStateCompat state) {
        ...
        android.support.v4.app.NotificationCompat.Action playPuseAction =
                new NotificationCompat.Action(icon, playPauseString,
        ...
        Notification notification = new NotificationCompat.Builder(this)
                ...
                .setContentTitle("What is author of this song?")
                .setContentText("Body text")
                .addAction(restartAction)
                .addAction(playPuseAction)
        ...
        if(mNontifactionManager == null) {
            mNontifactionManager = (NotificationManager) getSystemService(NOTIFICATION_SERVICE);
        }

        mNontifactionManager.notify(0, notification);
    }

    public static class MediaQuizReciever extends BroadcastReceiver{
        @Override
